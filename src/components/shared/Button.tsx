...
const ButtonModel = {
  ...
  dark:
    "bg-zinc-500 hover:bg-zinc-600 rounded font-medium text-white px-6 py-2",

  success:
    "bg-green-500 hover:bg-green-600 rounded font-medium text-white px-6 py-2",

  info:
    "bg-cyan-500 hover:bg-cyan-600 rounded font-medium text-white px-6 py-2",

  pink:
    "bg-pink-500 hover:bg-pink-600 rounded font-medium text-white px-6 py-2",
...
interface ButtonInterface {
  children : string;
  type? : "primary" | "secondary" | "danger" | "warning" | "dark" | "success" | "info" | "pink" | "darkPink" | "darkBlue" | "violet" | "like" | "dislike" | "comment"
  onClick?: ()=>void
  icon?: string
  key?: string | number
}
