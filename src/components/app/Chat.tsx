          ...
          <div className="space-y-12 " key={index}>
            <div className="flex gap-4 items-start">
              ...
              <div className="bg-pink-50 px-3 py-2 rounde-lg flex-1 text-pink-700 border-pink-100 relative">
                ...
                <label>
                  loem sit maet dollar this is how you write olorem dollar with
                  lowthis is how you write olorem dollar with low
                </label>
    ...
    <div className="p-3">
        <div className="flex items-center gap-4">
            <form className="flex gap-4 flex-1">
                ...
                <Button type="pink" icon="send-plane-fill">Send</Button>
            </form>
